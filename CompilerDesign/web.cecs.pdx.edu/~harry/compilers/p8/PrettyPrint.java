...
class PrettyPrint {
        ...
        throws FatalError
    {
        if (p == null) {
            ...
            throw new LogicError ("*****  Unknown class in ppCompoundType!  *****");
        }
    }
        ...
        throws FatalError
    {
        while (stmt != null) {
            if (stmt instanceof Ast.AssignStmt) {
                ...
                throw new LogicError ("*****  Unknown class within ppStmts!  *****");
            }
            stmt = stmt.next;
        }
    }
        ...
        throws FatalError
    {
        if (p instanceof Ast.BinaryOp) {
            ...
            throw new LogicError ("*****  Unknown class within ppExpr!  *****");
        }
    }
        ...
        throws FatalError
    {
        ...
        switch (p.op) {
            ...
            case Token.SLASH:
              ...
              break;
            default:
              throw new LogicError (" *****  Bad op in ppBinaryOp!  ***** ");
        }
        // printMode (p.mode);
        ppExpr (p.expr2);
        System.out.print (")");
        ...
        throws FatalError
    {
        switch (p.op) {
            ...
            case Token.MINUS:
              ...
              break;
            default:
              throw new LogicError ("*****  Bad op in ppUnaryOp!  *****");
        }
        // printMode (p.mode);
        ppExpr (p.expr);
    }
        ...
        throws FatalError
    {
        if (p instanceof Ast.Variable) {
            ...
            throw new LogicError ("*****  Unknown class in ppLValue!  *****");
        }
    }
